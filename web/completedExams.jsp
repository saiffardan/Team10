...
<html>
    ...
    <body>
        ...
        <%
            ...
            String query = "SELECT * from exam WHERE status = 'Completed'";
            ...
            try {
                ...
                while(rs.next())
                {
                    ...
                    out.println("<td><button onclick=\"window.print()\" type=\"submit\" value=\"print\">Click Me</button></td>");
                    out.println("</tr>");
                }
